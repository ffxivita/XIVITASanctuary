...
sealed internal class PStrings
{
    ...
    /// </summary>
    internal static readonly string supportButtonUrl = "https://github.com/sponsors/ffxivita";
...
sealed internal class TStrings
{
    ...
    internal static string SettingsShowSupportButtonTooltip => Loc.Localize("Settings.ShowSupportButton.Tooltip", "Show the support XIVITA Guide button");
    ...
    internal static string DutyInfoNoneSelected => Loc.Localize("DutyInfo.NoDuty", "No duty selected, use /xivitalist to see all available duties.");
